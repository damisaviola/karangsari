    ...
    <div class="footer clearfix mb-0 text-muted">
        ...
        <script src="<?= base_url('assets/dist/assets/static/js/pages/filepond.js') ?>"></script>
         ...
         <script src="<?= base_url('assets/dist/assets/extensions/quill/quill.min.js') ?>"></script>
         <script src="<?= base_url('assets/dist/assets/static/js/pages/quill.js') ?>"></script>
       ...
       <?php if ($this->uri->uri_string() == 'user/keluhan' || $this->uri->uri_string() == 'user/keluhan') : ?>
            <script src="<?= base_url('assets/dist/assets/compiled/js/app.js') ?>"></script>
        <?php endif; ?>

        <?php if ($this->uri->uri_string() == 'user/keluhan') : ?>
