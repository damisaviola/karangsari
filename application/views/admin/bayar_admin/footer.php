    ...
    <div class="footer clearfix mb-0 text-muted">
       ...
       <?php if ($this->uri->uri_string() == 'admin/pembayaran/bayar_admin' || $this->uri->uri_string() == 'admin/kamar/tambah_kamar') : ?>
            <script src="<?= base_url('assets/dist/assets/compiled/js/app.js') ?>"></script>
        <?php endif; ?>

        <?php if ($this->uri->uri_string() == 'admin/pembayaran/bayar_admin') : ?>
