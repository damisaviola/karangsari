                ...
                <div class="card-content pb-4">
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="<?= base_url('assets/dist/assets/compiled/jpg/4.jpg') ?>" alt="Face 4">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="<?= base_url('assets/dist/assets/compiled/jpg/3.jpg') ?>" alt="Face 3">
                        </div>
                        <div class="name ms-4">
                    ...
                    <div class="recent-message d-flex px-4 py-3">
                        <div class="avatar avatar-lg">
                            <img src="<?= base_url('assets/dist/assets/compiled/jpg/6.jpg') ?>" alt="Face 6">
                        </div>
                        <div class="name ms-4">
